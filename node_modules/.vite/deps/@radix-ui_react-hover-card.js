...
import {
  Presence
} from "./chunk-GOYWPJYJ.js";
import {
  useEscapeKeydown
} from "./chunk-RZ6LGTOL.js";
import {
  Primitive,
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React7.useRef(false);
  const isPointerDownOnContentRef = React7.useRef(false);
  ...
  const handleDismiss = React7.useCallback(() => setOpen(false), [setOpen]);
  React7.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React7.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContent = React7.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React7.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React7.useState(false);
  React7.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React7.forwardRef(
  (props, forwardedRef) => {
